package com.pl.skijumping.batch.eventimporterjob.configuration;

import com.pl.skijumping.batch.eventimporterjob.tasklet.EventIdImporterTaskletBatch;
...
public class EventImporterConfiguration {
    ...
    public static final String EVENT_IMPORTER_STEP_NAME = "Event_Importer_Step";
